...
const extraComplaints: Complaint[] = [
  ...
  mkComplaint({ id: 'TS-20260128-0103', title: '导游服务态度差', city: '黔东南苗族侗族自治州', district: '雷山县', method: 'province_phone', category: 'tour_guide', time: '2026-01-28', status: 'closed', respondent: '导游王某（D-5201-000201）', complainant: '杨帆', replyTime: '2026-02-05', content: '西江千户苗寨一日游导游全程服务态度差，言语生硬，行程讲解敷衍了事。' }),
  // 2月（春节）
  ...
  mkComplaint({ id: 'TS-20260217-0106', title: '景区限流未提前公告', city: '黔东南苗族侗族自治州', district: '雷山县', method: 'national_platform', category: 'scenic_area', time: '2026-02-17', status: 'closed', respondent: '西江千户苗寨景区', complainant: '郑洁', replyTime: '2026-02-24', content: '西江千户苗寨景区限流信息未提前公告，游客到达后无法入园，现场退票被拒。' }),
  mkComplaint({ id: 'TS-20260219-0107', title: '酒店卫生条件差', city: '贵阳市', district: '云岩区', method: 'province_phone', category: 'accommodation', time: '2026-02-19', status: 'closed', respondent: '贵阳云岩XX酒店', complainant: '王磊', replyTime: '2026-02-27', content: '酒店房间床品有污渍、卫生间有异味，要求换房前台态度消极。' }),
  // 3月
  mkComplaint({ id: 'TS-20260308-0108', title: '在线平台预订服务缩水', city: '遵义市', district: '红花岗区', method: 'national_platform', category: 'online_travel', time: '2026-03-08', status: 'closed', respondent: 'XX在线旅游平台', complainant: '李娜', replyTime: '2026-03-15', content: '平台预订酒店宣传"含双早"，入住后酒店称无此服务，涉嫌虚假宣传，要求退差价。' }),
  ...
  mkComplaint({ id: 'TS-20260328-0111', title: '咨询类来电（非投诉）', city: '贵阳市', method: 'province_phone', category: 'other', time: '2026-03-28', status: 'not_accepted', respondent: '无', complainant: '陈晨', content: '来电咨询旅游补贴政策办理流程，经甄别为咨询类事项，不属于投诉受理范围，已转咨询电话答复。' }),
  // 4月
  ...
  mkComplaint({ id: 'TS-20260410-0114', title: '旅游包车涉嫌超载运营', city: '铜仁市', district: '江口县', method: 'national_platform', category: 'transportation', time: '2026-04-10', status: 'transferred', respondent: '江口XX客运公司', complainant: '吴倩', transferred: true, suspectedIssue: '客运包车招揽包车合同以外的旅客并超载，涉嫌违反《道路旅客运输及客运站管理规定》', transferDept: '交通运输执法部门', transferTheme: '旅游交通客运', content: '梵净山旅游专线车辆超载行驶，核载33人实际载客40人，存在严重安全隐患。' }),
  mkComplaint({ id: 'TS-20260418-0115', title: '导游车上兜售商品', city: '贵阳市', district: '花溪区', method: 'province_phone', category: 'tour_guide', time: '2026-04-18', status: 'closed', respondent: '导游刘某（D-5201-000312）', complainant: '王芳', replyTime: '2026-04-25', content: '导游在车上长时间兜售土特产，不购买的游客被安排在车辆后排座位。' }),
  // 5月（五一）
  ...
  mkComplaint({ id: 'TS-20260503-0118', title: '景区内商户强制消费', city: '黔东南苗族侗族自治州', district: '雷山县', method: 'province_phone', category: 'scenic_area', time: '2026-05-03', status: 'transferred', respondent: '西江千户苗寨景区', complainant: '刘军', transferred: true, suspectedIssue: '景区内商户强制消费，涉嫌违反《旅游法》第三十五条', transferDept: '市场监管部门', transferTheme: '价格秩序及商品经营', content: '西江千户苗寨景区内商户强制消费，不购买银饰不让通过游线，疑似与导游串通。' }),
  ...
  mkComplaint({ id: 'TS-20260505-0120', title: '景区观光车调度混乱', city: '六盘水市', district: '盘州市', method: 'national_platform', category: 'scenic_area', time: '2026-05-05', status: 'closed', respondent: '乌蒙大草原景区', complainant: '刘一鸣', replyTime: '2026-05-14', content: '景区观光车调度混乱，游客长时间滞留，且安全提示不到位。' }),
  // 6月
  ...
  mkComplaint({ id: 'TS-20260620-0123', title: '"纯玩团"实际含购物点', city: '安顺市', district: '西秀区', method: 'province_phone', category: 'travel_agency', time: '2026-06-20', status: 'replied', respondent: '贵州头等舱旅行社', complainant: '周婷', replyTime: '2026-06-28', content: '贵州头等舱旅行社宣传"纯玩无购物"行程实际含两个购物点，要求退差价并道歉。' }),
  ...
  mkComplaint({ id: 'TS-20260712-0129', title: '夜游景区排队久无疏导', city: '黔东南苗族侗族自治州', district: '雷山县', method: 'national_platform', category: 'scenic_area', time: '2026-07-12', status: 'closed', respondent: '西江千户苗寨景区', complainant: '刘洋', replyTime: '2026-07-19', content: '暑期夜游西江千户苗寨排队时间过长，观景台限流但无工作人员疏导。' }),
  mkComplaint({ id: 'TS-20260715-0130', title: '行程酒店降级要求退差价', city: '遵义市', district: '汇川区', method: 'letter_visit', category: 'travel_agency', time: '2026-07-15', status: 'closed', respondent: '贵州瀚博国际旅行社', complainant: '陈晨', replyTime: '2026-07-22', content: '行程中酒店被降级为快捷酒店，与合同约定的星级不符，要求退差价。' }),
  mkComplaint({ id: 'TS-20260717-0131', title: '玉器店价格虚高疑设购物陷阱', city: '贵阳市', district: '南明区', method: 'province_phone', category: 'shopping', time: '2026-07-17', status: 'closed', respondent: '贵阳XX珠宝店', complainant: '杨光', replyTime: '2026-07-24', content: '玉器店商品价格虚高，标价与实际支付金额不符，疑似团队购物陷阱，要求退款。' }),
  ...
  mkComplaint({ id: 'TS-20260722-0133', title: '网上订单被单方取消加价', city: '安顺市', district: '西秀区', method: 'national_platform', category: 'travel_agency', time: '2026-07-22', status: 'closed', respondent: '贵州云游黔程旅行社', complainant: '吴倩', replyTime: '2026-07-29', content: '网上预订的行程被贵州云游黔程旅行社单方取消，临时加价才能出行，且拒绝退款。' }),
  mkComplaint({ id: 'TS-20260724-0134', title: '景区摆渡车长时间等待', city: '黔南布依族苗族自治州', district: '荔波县', method: 'province_phone', category: 'scenic_area', time: '2026-07-24', status: 'closed', respondent: '荔波小七孔景区', complainant: '王芳', replyTime: '2026-07-31', content: '荔波小七孔景区摆渡车等待时间过长，游客长时间暴晒，现场无遮阳设施。' }),
  ...
  mkComplaint({ id: 'TS-20260730-0136', title: '演出临时取消拒绝退款', city: '贵阳市', district: '观山湖区', method: 'national_platform', category: 'entertainment', time: '2026-07-30', status: 'closed', respondent: '贵阳XX演艺中心', complainant: '张敏', replyTime: '2026-08-05', content: '演出场次被临时取消，票务方拒绝退款，退改规则不合理。' }),
  // 8月（暑期）
  ...
  mkComplaint({ id: 'TS-20260820-0141', title: '导游擅自增加自费项目', city: '贵阳市', district: '南明区', method: 'province_phone', category: 'tour_guide', time: '2026-08-20', status: 'processing', respondent: '导游杨某（D-5226-000789）', complainant: '杨帆', content: '黄果树一日游导游擅自增加自费项目，未参加的游客被留在车上等待。' }),
  ...
  mkComplaint({ id: 'TS-20260220-0144', title: '景区商户未明码标价涉嫌欺客宰客', city: '安顺市', district: '镇宁布依族苗族自治县', method: 'letter_visit', category: 'scenic_area', time: '2026-02-20', status: 'closed', respondent: '黄果树瀑布景区周边商户', complainant: '徐婷', transferred: true, suspectedIssue: '未明码标价、涉嫌欺客宰客，涉嫌违反《价格法》', transferDept: '市场监管部门', transferTheme: '价格秩序及商品经营', replyTime: '2026-03-10', content: '景区周边餐饮商户未明码标价，结账价格远高于标示价，涉嫌欺客宰客。' }),
  mkComplaint({ id: 'TS-20260318-0145', title: '古镇商铺价格欺诈', city: '贵阳市', district: '花溪区', method: 'province_phone', category: 'shopping', time: '2026-03-18', status: 'closed', respondent: '青岩古镇XX银饰店', complainant: '孙悦', transferred: true, suspectedIssue: '标价与实际结算不符涉嫌价格欺诈，涉嫌违反《价格法》', transferDept: '市场监管部门', transferTheme: '价格秩序及商品经营', replyTime: '2026-04-02', content: '商铺以低价标示招揽，结算时高价收取且不提供票据，涉嫌价格欺诈。' }),
  mkComplaint({ id: 'TS-20260326-0150', title: '购物店以次充好虚假宣传', city: '黔东南苗族侗族自治州', district: '雷山县', method: 'national_platform', category: 'shopping', time: '2026-03-26', status: 'transferred', respondent: '西江千户苗寨XX银器店', complainant: '胡兵', transferred: true, suspectedIssue: '以次充好、虚假宣传，涉嫌违反《消费者权益保护法》', transferDept: '市场监管部门', transferTheme: '价格秩序及商品经营', content: '所购银器经鉴定为镀银铜器，商家虚假宣传"足银999"，要求查处。' }),
  mkComplaint({ id: 'TS-20260422-0146', title: '旅行社服务网点涉嫌超范围经营', city: '贵阳市', district: '南明区', method: 'province_phone', category: 'travel_agency', time: '2026-04-22', status: 'transferred', respondent: '贵州盈科旅行社服务网点', complainant: '袁媛', transferred: true, suspectedIssue: '服务网点销售旅游鞋涉嫌超范围经营', transferDept: '市场监管部门', transferTheme: '旅行社资质及经营规范', content: '旅行社服务网点门市长期摆卖旅游鞋等商品，涉嫌超出许可经营范围经营。' }),
  mkComplaint({ id: 'TS-20260520-0148', title: '旅游项目资金使用问题线索', city: '贵阳市', district: '云岩区', method: 'province_phone', category: 'other', time: '2026-05-20', status: 'transferred', respondent: '贵州XX文旅项目公司', complainant: '秦峰', transferred: true, suspectedIssue: '反映旅游项目补助资金使用不规范', transferTheme: '项目资金管理', content: '反映某文旅项目补助资金使用不规范，具体移送部门待进一步核实明确。' }),
  mkComplaint({ id: 'TS-20260610-0147', title: '景区直升机驾驶员未持有效执照飞行', city: '铜仁市', district: '江口县', method: 'national_platform', category: 'entertainment', time: '2026-06-10', status: 'transferred', respondent: '梵净山低空游览运营公司', complainant: '曹磊', transferred: true, suspectedIssue: '直升机驾驶员未持有效驾驶员执照飞行、景区运营主体审核把关不严，涉嫌违反《民用航空法》', transferDept: '公安机关', transferTheme: '安全管理及飞行资质', content: '景区观光直升机驾驶员无法出示有效执照，景区运营主体审核把关不严，存在重大安全隐患。' }),
  mkComplaint({ id: 'TS-20260628-0149', title: '景区运营公司驾驶员未落实预约下单', city: '铜仁市', district: '江口县', method: 'province_phone', category: 'transportation', time: '2026-06-28', status: 'transferred', respondent: '贵州梵净山旅游商务服务有限公司', complainant: '沈飞', transferred: true, suspectedIssue: '多名驾驶员未落实网约车预约下单，反映监管失职问题', transferDept: '纪检监察机关', transferTheme: '其他/未注明', content: '景区接驳车辆多名驾驶员未落实网约车预约下单要求，反映相关部门监管失职。' }),
  mkComplaint({ id: 'TS-20260706-0151', title: '在线平台门票加价销售', city: '安顺市', district: '西秀区', method: 'national_platform', category: 'online_travel', time: '2026-07-06', status: 'transferred', respondent: 'XX在线旅游平台', complainant: '韩雪', transferred: true, suspectedIssue: '平台加价销售景区门票且价格公示不规范，涉嫌违反《价格法》', transferDept: '市场监管部门', transferTheme: '价格秩序及商品经营', content: '在线平台销售的龙宫景区门票加价明显且未公示价格构成，涉嫌违规加价。' }),
];
...
export const MockComplaints: Complaint[] = [
  ...
  },
  {
    ...
    city: '黔东南苗族侗族自治州',
    district: '雷山县',
    complaintSource: 'province_phone',
  ...
  },
  {
    ...
    city: '遵义市',
    district: '红花岗区',
    complaintSource: 'national_platform',
...
export const MockSubsidyApplications: SubsidyApplication[] = [
  ...
  (() => {
    ...
    app.status = 'submitted'; // 行程已结束的历史提交记录
    app.legalRepresentative = '张文华';
    app.contactPhone = '0851-85888888';
    app.bankAccount = { accountName: '贵州阳光国际旅行社', bankName: '中国工商银行贵阳分行', accountNo: '2402000109201088888' };
